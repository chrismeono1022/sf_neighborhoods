...
The parsed data can be found in [/public/sf-oak-neighborhoods.json](https://raw.githubusercontent.com/chrismeono1022/sf_neighborhoods/master/public/sf-oak-neighborhoods.json). I took the Zillow Neighborhood Boundaries and converted them to GeoJSON via [GDAL](http://www.gdal.org/ogr2ogr.html).
...
I then used the Mouseover event handler to expose the neighborhood name when you hover over it. You can see the javascript code [here](https://github.com/chrismeono1022/sf_neighborhoods/blob/master/app/assets/javascripts/map.js).
